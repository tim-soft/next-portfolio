...
const LibraryPage = ({ route, theme }) => (
    <ThemeProvider theme={theme}>
        <LibraryLayout route={route}>
            <section>
                <p>
                    <BlogCodeInline>react-spring-lightbox</BlogCodeInline> is a
                    modal photo gallery that aims to replicate{' '}
                    <strong>all</strong> of the input UX of hardware-accelerated
                    native image applications from touch swiping to{' '}
                    <BlogCodeInline>Ctrl + Mousewheel</BlogCodeInline> zooming.
                </p>
            </section>
            <section>
                ...
                <ul>
                    <li>
                        ...
                        <BlogCodeInline>Mousewheel</BlogCodeInline>, swipe or
                        click+drag to page photos
                    </li>
                    <li>
                        <span role="img" aria-label="keyboard">
                            ⌨️
            ...
            <section>
                <h2>Demos</h2>
                <p>
                    Out of the box, this library purposely does not include any
                    UI elements (header, footer, buttons etc). With the
                    available{' '}
                ...
                <p>
                    All that is included is the image stage which implements all
                    gestures (press <BlogCodeInline>Esc</BlogCodeInline> to
                    close).
                </p>
                <LightboxDemoNoUI />
                <p>
