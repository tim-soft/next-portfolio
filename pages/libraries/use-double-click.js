...
const LibraryPage = ({ route, theme }) => (
  <ThemeProvider theme={theme}>
    <LibraryLayout route={route}>
      <section>
        <p>
          <BlogCodeInline>use-double-click</BlogCodeInline> is a simple React
          hook for differentiating single and double clicks on the same
          component.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          ...
          <BlogCodeInline>onClick()</BlogCodeInline> callback fires twice
          alongside your single <BlogCodeInline>onDoubleClick()</BlogCodeInline>{' '}
          callback. This effect isn&apos;t desirable when a single click and a
          double click have different functions!
        </p>
        <p>
          <BlogCodeInline>useDoubleClick()</BlogCodeInline> waits within a
          latency window after a click for a secondary click, and only after
