...
const BlogPage = ({ route, theme }) => (
    <ThemeProvider theme={theme}>
        <BlogPostLayout route={route}>
            <BlogParagraph>
                Unlike your React components, the event listeners they&apos;ve
                created don&apos;t magically disappear after their UI unmounts
                from the DOM. Undisposed event listeners will linger in your
                browser to haunt future components. Be afraid.
            </BlogParagraph>
            <BlogParagraph>
                For example, let&apos;s say you want to create a simple
                component that displays the <strong>instantaneous</strong>{' '}
                window width.
            </BlogParagraph>
            <BlogParagraph>
                The first step is to create a function for setting some
                component state we&apos;ll call{' '}
                <strong>
    ...
    windowWidth: window.innerWidth
      ...
      `}
            ...
            <BlogParagraph>
                ...
                is called directly. As the window size changes, the event
                listener we&apos;ve created calls the same function as a
                callback.
            </BlogParagraph>
            <BlogParagraph>
                Before the current component unmounts, our event listener must
                be removed from the{' '}
                <strong>
            ...
            <BlogParagraph>
                All together the code is quite simple and can save you from a
