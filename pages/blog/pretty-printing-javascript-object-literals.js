  ...
  <ThemeProvider theme={theme}>
    <BlogArticleContainer route={route}>
      ...
      <BlogParagraph>
        ...
        I began realizing how convenient it would be to copy + paste the current
        config directly into your own code. I already had the entire particle
        config saved in React state for updating the particles as you change
        it&apos;s parameters. Luckily, all I needed was to get that object into
        the browser somehow.
      </BlogParagraph>
      <BlogParagraph>
        Consulting the{' '}
        ...
        object as JSON, we cannot modify the formatting to make our JSON appear
      ...
      <BlogParagraph>
        After pouring over countless Stack Overflow and Google search results, I
        finally came across a package for solving this exact problem:{` `}
        <BlogLink
...
const configString = stringifyObject(config, {
  ...
  singleQuotes: true
      ...
      <BlogParagraph>
        ...
        <BlogCodeInline>stringifyObject()</BlogCodeInline>, one could simply run
        it through a syntax highlighter like I&apos;ve detailed in my post{' '}
        <BlogLink href="/blog/building-react-code-blocks-with-prism" paragraph>
